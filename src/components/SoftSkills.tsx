  ...
  const skills = [
    {
      title: "Comunicação",
      description:
        "Capacidade de explicar conceitos técnicos complexos de forma clara e acessível para diferentes públicos.",
      icon: MessageCircle,
      examples: [
    ...
    },
    {
      ...
      description:
        "Abordagem analítica e criativa para identificar, analisar e resolver desafios de segurança.",
      icon: Lightbulb,
      examples: [
    ...
    },
    {
      title: "Organização",
      description:
        "Gestão eficiente de tarefas, projetos e tempo, mantendo alta qualidade nos entregáveis.",
      icon: Calendar,
      examples: [
    ...
    },
    {
      ...
      description:
        "Dedicação total aos objetivos, buscando sempre a excelência e melhoria contínua.",
      icon: Heart,
      examples: [
    ...
    },
    {
      ...
      description:
        "Colaboração efetiva, compartilhamento de conhecimento e contribuição para o sucesso coletivo.",
      icon: Users,
      examples: [
        ...
        <ScrollReveal width="100%" className="max-w-6xl mx-auto">
          ...
          <div className="mt-12 text-center">
            <h3 className="text-lg font-semibold mb-4">
              Áreas de Desenvolvimento Contínuo
            </h3>
